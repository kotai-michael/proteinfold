...
process RUN_BOLTZ {
    ...
    tuple val(meta), path ("${meta.id}_plddt.tsv")                              , optional: true, emit: plddt_raw
    ...
    tuple val(meta), path ("${meta.id}_*_ptm.tsv")                              , optional: true, emit: ptm_raw
    tuple val(meta), path ("${meta.id}_*_iptm.tsv")                             , optional: true, emit: iptm_raw
    ...
    extract_output.py --name ${meta.id} \\
        --structs "boltz_results_*/predictions/*/*.pdb" \\
        --jsons "boltz_results_*/predictions/confidence_*_model_*.json" \\
        --npzs "boltz_results_*/processed/msa/*.npz" "boltz_results_*/predictions/pae_*_model_*.npz" \\
